...
psql -v ON_ERROR_STOP=1 --username "$POSTGRES_USER" --dbname "postgres" <<-EOSQL
    ...
    CREATE USER $ALERTS_SERVICE_DB_USER WITH PASSWORD '$ALERTS_SERVICE_DB_PASSWORD';
    CREATE DATABASE $ALERTS_SERVICE_DB_NAME;
    ALTER DATABASE $ALERTS_SERVICE_DB_NAME OWNER TO $ALERTS_SERVICE_DB_USER;
