...
func (x *Sensor) GetLastUpdated() *timestamppb.Timestamp {
	if x != nil {
...
func (x *SensorGroup) GetCreatedAt() *timestamppb.Timestamp {
	if x != nil {
		return x.CreatedAt
	}
	return nil
...
func (x *SensorGroup) GetUpdatedAt() *timestamppb.Timestamp {
	if x != nil {
		return x.UpdatedAt
	}
	return nil
...
type ListSensorGroupsResponse struct {
	state         protoimpl.MessageState    `protogen:"open.v1"`
	Groups        []*SensorGroupWithSensors `protobuf:"bytes,1,rep,name=groups,proto3" json:"groups,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
