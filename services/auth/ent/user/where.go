...
func RefreshTokenExpires(v time.Time) predicate.User {
...
func RefreshTokenExpiresEQ(v time.Time) predicate.User {
	return predicate.User(sql.FieldEQ(FieldRefreshTokenExpires, v))
}

// RefreshTokenExpiresNEQ applies the NEQ predicate on the "refresh_token_expires" field.
func RefreshTokenExpiresNEQ(v time.Time) predicate.User {
	return predicate.User(sql.FieldNEQ(FieldRefreshTokenExpires, v))
}

// RefreshTokenExpiresIn applies the In predicate on the "refresh_token_expires" field.
func RefreshTokenExpiresIn(vs ...time.Time) predicate.User {
	return predicate.User(sql.FieldIn(FieldRefreshTokenExpires, vs...))
}

// RefreshTokenExpiresNotIn applies the NotIn predicate on the "refresh_token_expires" field.
func RefreshTokenExpiresNotIn(vs ...time.Time) predicate.User {
	return predicate.User(sql.FieldNotIn(FieldRefreshTokenExpires, vs...))
}

// RefreshTokenExpiresGT applies the GT predicate on the "refresh_token_expires" field.
func RefreshTokenExpiresGT(v time.Time) predicate.User {
	return predicate.User(sql.FieldGT(FieldRefreshTokenExpires, v))
}

// RefreshTokenExpiresGTE applies the GTE predicate on the "refresh_token_expires" field.
func RefreshTokenExpiresGTE(v time.Time) predicate.User {
	return predicate.User(sql.FieldGTE(FieldRefreshTokenExpires, v))
}

// RefreshTokenExpiresLT applies the LT predicate on the "refresh_token_expires" field.
func RefreshTokenExpiresLT(v time.Time) predicate.User {
	return predicate.User(sql.FieldLT(FieldRefreshTokenExpires, v))
}

// RefreshTokenExpiresLTE applies the LTE predicate on the "refresh_token_expires" field.
func RefreshTokenExpiresLTE(v time.Time) predicate.User {
	return predicate.User(sql.FieldLTE(FieldRefreshTokenExpires, v))
}

// RefreshTokenExpiresIsNil applies the IsNil predicate on the "refresh_token_expires" field.
func RefreshTokenExpiresIsNil() predicate.User {
	return predicate.User(sql.FieldIsNull(FieldRefreshTokenExpires))
}
