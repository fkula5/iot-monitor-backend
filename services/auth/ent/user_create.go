...
func (uc *UserCreate) SetRefreshTokenExpires(t time.Time) *UserCreate {
	uc.mutation.SetRefreshTokenExpires(t)
	return uc
}

// SetNillableRefreshTokenExpires sets the "refresh_token_expires" field if the given value is not nil.
func (uc *UserCreate) SetNillableRefreshTokenExpires(t *time.Time) *UserCreate {
	if t != nil {
		uc.SetRefreshTokenExpires(*t)
	}
	return uc
}
