...
import (
	...
	"github.com/skni-kod/iot-monitor-backend/services/auth/ent/predicate"
...
func (m *UserMutation) SetRefreshTokenExpires(t time.Time) {
	m.refresh_token_expires = &t
}

// RefreshTokenExpires returns the value of the "refresh_token_expires" field in the mutation.
func (m *UserMutation) RefreshTokenExpires() (r time.Time, exists bool) {
...
// OldRefreshTokenExpires returns the old "refresh_token_expires" field's value of the User entity.
// If the User object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *UserMutation) OldRefreshTokenExpires(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
...
// ClearRefreshTokenExpires clears the value of the "refresh_token_expires" field.
func (m *UserMutation) ClearRefreshTokenExpires() {
	m.refresh_token_expires = nil
	m.clearedFields[user.FieldRefreshTokenExpires] = struct{}{}
}

// RefreshTokenExpiresCleared returns if the "refresh_token_expires" field was cleared in this mutation.
func (m *UserMutation) RefreshTokenExpiresCleared() bool {
	_, ok := m.clearedFields[user.FieldRefreshTokenExpires]
	return ok
}

// ResetRefreshTokenExpires resets all changes to the "refresh_token_expires" field.
func (m *UserMutation) ResetRefreshTokenExpires() {
	m.refresh_token_expires = nil
	delete(m.clearedFields, user.FieldRefreshTokenExpires)
}
...
func (m *UserMutation) ClearResetTokenExpires() {
	m.reset_token_expires = nil
	m.clearedFields[user.FieldResetTokenExpires] = struct{}{}
}

// ResetTokenExpiresCleared returns if the "reset_token_expires" field was cleared in this mutation.
func (m *UserMutation) ResetTokenExpiresCleared() bool {
	_, ok := m.clearedFields[user.FieldResetTokenExpires]
	return ok
}
...
func (m *UserMutation) ResetResetTokenExpires() {
	m.reset_token_expires = nil
	delete(m.clearedFields, user.FieldResetTokenExpires)
}
...
func (m *UserMutation) Fields() []string {
	...
	if m.refresh_token_expires != nil {
		fields = append(fields, user.FieldRefreshTokenExpires)
	}
...
func (m *UserMutation) Field(name string) (ent.Value, bool) {
	...
	case user.FieldRefreshTokenExpires:
...
func (m *UserMutation) ClearedFields() []string {
	...
	if m.FieldCleared(user.FieldRefreshTokenExpires) {
		fields = append(fields, user.FieldRefreshTokenExpires)
	}
	if m.FieldCleared(user.FieldResetToken) {
		fields = append(fields, user.FieldResetToken)
	}
	if m.FieldCleared(user.FieldResetTokenExpires) {
		fields = append(fields, user.FieldResetTokenExpires)
	}
	return fields
}
...
func (m *UserMutation) ClearField(name string) error {
	...
	case user.FieldRefreshToken:
		...
		return nil
	case user.FieldRefreshTokenExpires:
		m.ClearRefreshTokenExpires()
		return nil
	case user.FieldResetToken:
		m.ClearResetToken()
		return nil
	case user.FieldResetTokenExpires:
		m.ClearResetTokenExpires()
		return nil
	}
